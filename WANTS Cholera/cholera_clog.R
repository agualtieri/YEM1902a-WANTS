# WASH Cholera Tool - Data Cleaning script
...
response <- read.xlsx("./data/WASH Cholera Key Informant Questionnaire_test.xlsx")
...
cleaning_log <- read.xlsx("./output/WASH_Cholera Tool_Master Cleaning Log.xlsx")
...
## Save cleaned data
### DB Version
write.xlsx(clean_data, paste0("./output/db/WASH_Cholera Tool Final DB_",today,".xlsx"))
...
write.xlsx(final, paste0("./output/final/WASH_Cholera Tool Final_",today,".xlsx"))
